...
.. figure:: img/001_user_group_service.png
    :align: center

3. Click on ``AuthKEY WebService Body Response``

.. figure:: img/002_user_group_service.png
    :align: center
...
.. figure:: img/003_user_group_service.png
    :align: center
...
.. figure:: img/004_user_group_service.png
    :align: center
...
.. figure:: img/005_user_group_service.png
    :align: center
...
1. *Optional static comma-separated list of available Groups from the Web Service response*
  ...
  .. figure:: img/006_user_group_service.png
      :align: center

  .. figure:: img/007_user_group_service.png
      :align: center
  ...
  .. figure:: img/008_user_group_service.png
      :align: center
  ...
  .. figure:: img/009_user_group_service.png
      :align: center
...
2. *Role Service to use*
  ...
  By default, if no ``Role Service`` specified, the ``UserGroup Service`` will use the ``GeoServer Active Role Service`` to resolve ``GeoServer User Roles`` from ``GeoServer User Groups`` - as specified above -
    ...
    .. figure:: img/010_user_group_service.png
        :align: center
  ...
  It is possible to define a ``Custom Role Service`` to use instead, to resole ``GeoServer User Roles``; this is possible simply by selecting the ``Role Service`` to use from the ``Role Service to use`` option
    ...
    .. figure:: img/011_user_group_service.png
        :align: center
